...
<body>
    ...
    <br /><br />
      ...
      <div class="row">
       <%-- <ul>
      <%
      List<String> list= (ArrayList<String>)session.getAttribute("suggession");
      ...
      %>
      <h5>You may searching for...</h5>
      <% 
      
      for(String sug:list)
    	  
      {%>
      	<a href="#"><li style="list-style:none;"><%=sug+"\t\t" %></li></a>
	...
	%>
        ...
        <div class="col-md-6">
         <div class="card my-4" >
            <div class="card-body">
	            <a href="rank.jsp %>" >
	             <img class="img-fluid rounded mb-3 mb-md-0" src="images/rank.png" alt=""  >
	            </a>
	        </div>
	     </div>
        </div>
        <div class="col-md-5" >
          <h3 style="margin-top:15px;">Ranking of Sri Lankan Universities</h3>
          <p >If you want to study in Sri Lanka, then you need to know which of its universities are right for you. 
          Times Higher Education World University Rankings take the top institutions in the world, and look at their 
          performance across all of their core objectives: teaching, research, knowledge transfer and international 
          outlook.
          
          </p>
          
          
          <a  class="btn btn-primary" href="rank.jsp?" style={top:-100px}>Read More</a>
        </div>
      </div>
      <!-- /.row -->
...
%>
      ...
      <ul class="pagination justify-content-center">
        ...
        <li class="page-item">
          <a  class="page-link active"  href="search.jsp" >1</a>
        </li>
        <li class="page-item">
          <a class="page-link" href="search2.jsp" >2</a>
        </li>
        <li class="page-item">
        ...
        <li class="page-item">
          <a class="page-link" href="search2.jsp" aria-label="Next">
